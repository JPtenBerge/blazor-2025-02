...
public class CommentsRepository(HttpClient httpClient) : ICommentsRepository
{
    ...
    {
        var requestMessage = new HttpRequestMessage(HttpMethod.Post, "/apiauth/comments");
        requestMessage.SetBrowserRequestOption("redirect", "follow");

        requestMessage.Content = JsonContent.Create(comment);
