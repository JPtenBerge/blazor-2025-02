...
namespace PhotoSharingApplication.Migrations.PhotosDb
{
    ...
    [Migration("20240830103917_PhotoLatLon")]
    partial class PhotoLatLon
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoSharingApplication.Core.Models.PhotoImage", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhotoSharingApplication.Core.Models.PhotoImage", b =>
                {
                    b.HasOne("PhotoSharingApplication.Core.Models.Photo", null)
                        .WithOne("PhotoImage")
                        .HasForeignKey("PhotoSharingApplication.Core.Models.PhotoImage", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
